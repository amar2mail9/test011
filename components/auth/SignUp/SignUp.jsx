...
import { SignUpForm } from "./SignupForm"; // Make sure this file exists and is light-theme
import Link from "next/link";

const SignUp = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 relative overflow-hidden text-gray-800">
      ...
      <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center justify-center z-10 space-y-12 lg:space-y-0">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-sm leading-relaxed">
            Create an account to explore cutting-edge tools and elevate your
            productivity to the next level.
          </p>

          <div className="mt-16 text-md text-gray-600">
        ...
        >
          ...
          >
            <div className="relative w-48 h-48 bg-gray-100/60 rounded-xl p-4 shadow-lg flex items-center justify-center border border-gray-200">
              <div className="w-16 h-16 bg-gray-200 rounded-full relative flex items-center justify-center">
                <div className="absolute bottom-0 right-0 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center border-2 border-gray-100">
                  <svg
